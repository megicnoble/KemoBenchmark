function setupContainer(container, dropdownId) {
  ...
  function changeColorDropdown() {
    ...
    let prevGradient = container.querySelector(
  ...
  function updateInfo(color, container) {
    ...
    if (color === "RX 7900 GRE") {
      ...
      proInfo.innerHTML =
        "• 16GB GDDR6<br>• 2245 MHz Boost Clock<br>• 600 W Min PSU<br>";
    } else if (color === "RX 7800 XT") {
      header.textContent = "AMD";
      proName.textContent = "RX 7800 XT";
      fullName.textContent = "Radeon™ RX 7800 XT";
      proInfo.innerHTML =
        "• 16GB GDDR6<br>• 2430 MHz Boost Clock<br>• 600 W Min PSU<br>";
    } else if (color === "RX 7700 XT") {
      header.textContent = "AMD";
      proName.textContent = "RX 7700 XT";
      fullName.textContent = "Radeon™ RX 7700 XT";
      proInfo.innerHTML =
        "• 12GB GDDR6<br>• 2544 MHz Boost Clock<br>• 550 W Min PSU<br>";
    } else if (color === "RX 7600 XT") {
      header.textContent = "AMD";
      proName.textContent = "RX 7600 XT";
      fullName.textContent = "Radeon™ RX 7600 XT";
      proInfo.innerHTML =
        "• 16GB GDDR6<br>• 2755 MHz Boost Clock<br>• 450 W Min PSU<br>";
    } else if (color === "RX 7600") {
      header.textContent = "AMD";
      proName.textContent = "RX 7600";
      fullName.textContent = "Radeon™ RX 7600";
      proInfo.innerHTML =
        "• 8GB GDDR6<br>• 2655 MHz Boost Clock<br>• 450 W Min PSU<br>";
    } else if (color === "RX 6600 XT") {
      header.textContent = "AMD";
      proName.textContent = "RX 6600 XT";
      fullName.textContent = "Radeon™ RX 6600 XT";
      proInfo.innerHTML =
        "• 8GB GDDR6<br>• 2589 MHz Boost Clock<br>• 450 W Min PSU<br>";
    } else if (color === "RTX 4090") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4090";
      fullName.textContent = "GeForce RTX 4090";
      proInfo.innerHTML =
        "• 24GB GDDR6X<br>• 2520 MHz Boost Clock<br>• 850 W Min PSU<br>";
    } else if (color === "RTX 4080 Super") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4080 Super";
      fullName.textContent = "GeForce RTX 4080 Super";
      proInfo.innerHTML =
        "• 16GB GDDR6X<br>• 2550 MHz Boost Clock<br>• 700 W Min PSU<br>";
    } else if (color === "RTX 4080") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4080";
      fullName.textContent = "GeForce RTX 4080";
      proInfo.innerHTML =
        "• 16GB GDDR6X<br>• 2505 MHz Boost Clock<br>• 700 W Min PSU<br>";
    } else if (color === "RTX 4070 S") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4070 S";
      fullName.textContent = "GeForce RTX 4070 Super";
      proInfo.innerHTML =
        "• 12GB GDDR6X<br>• 2475 MHz Boost Clock<br>• 550 W Min PSU<br>";
    } else if (color === "RTX 4070") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4070";
      fullName.textContent = "GeForce RTX 4070";
      proInfo.innerHTML =
        "• 12GB GDDR6X<br>• 2475 MHz Boost Clock<br>• 550 W Min PSU<br>";
    } else if (color === "RTX 4060") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 4060";
      fullName.textContent = "GeForce RTX 4060";
      proInfo.innerHTML =
        "• 8GB GDDR6X<br>• 2460 MHz Boost Clock<br>• 300 W Min PSU<br>";
    } else if (color === "RTX 3070") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 3070";
      fullName.textContent = "GeForce RTX 3070";
      proInfo.innerHTML =
        "• 8GB GDDR6X<br>• 1725 MHz Boost Clock<br>• 550 W Min PSU<br>";
    } else if (color === "RTX 3060 12GB") {
      header.textContent = "NVIDIA";
      proName.textContent = "RTX 3060";
      fullName.textContent = "GeForce RTX 3060";
      proInfo.innerHTML =
        "• 12GB GDDR6X<br>• 1777 MHz Boost Clock<br>• 450 W Min PSU<br>";
    } else if (color === "GTX 1660 SUPER") {
      header.textContent = "NVIDIA";
      proName.textContent = "GTX 1660 SUPER";
      fullName.textContent = "GeForce GTX 1660 Super";
      proInfo.innerHTML =
        "• 6GB GDDR6X<br>• 1785 MHz Boost Clock<br>• 300 W Min PSU<br>";
    }
  }
