...
function setupContainer(container, dropdownId) {
    ...
    function updateInfo(color, container) {
        ...
        if (color === "RX 7900 GRE") {
            ...
            proInfo.innerHTML = "• 12GB GDDR6X<br>• 2475 MHz Boost Clock<br>• 550 W Min PSU<br>";
        }
            ...
            proInfo.innerHTML = "• 8GB GDDR6X<br>• 2460 MHz Boost Clock<br>• 300 W Min PSU<br>";
        } 
            ...
            proInfo.innerHTML = "• 6GB GDDR6X<br>• 1785 MHz Boost Clock<br>• 300 W Min PSU<br>";
        }
    }
